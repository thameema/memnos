...
def main():
    ...
    tp = transcript([
        ...
        a("Done — raised PROJ-471 and PROJ-472,"),
        {"type": "assistant", "message": {"content": [
            {"type": "tool_use", "id": "x"},
            {"type": "text", "text": "anchored to PROJ-467 as the anchor ticket."}]}},
    ])
    ...
    check("remember: assistant reply captured with identifiers verbatim",
          "PROJ-471" in atext and "PROJ-472" in atext and "PROJ-467" in atext)
