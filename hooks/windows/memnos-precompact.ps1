# memnos-precompact.ps1
#
# Claude Code PreCompact hook — saves session state to memnos before context compact.
...
#   "command": "powershell.exe -NonInteractive -NoProfile -File \"C:\\path\\to\\memnos-precompact.ps1\""
...
$payload = @{
    ...
    provenance  = @{ tool = "memnos-precompact-hook"; agent_id = $SessionId }
