...
set -a; . /Users/thameema/git/memnos/.env 2>/dev/null; . /Users/thameema/git/memnos/poc/.env 2>/dev/null; set +a
exec /Users/thameema/git/memnos/poc/.venv/bin/python -u memnos_consolidate.py
