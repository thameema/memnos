...
_MIGRATION_MODULES = [
    "memnos.migrations.versions.001_initial_schema",
    "memnos.migrations.versions.002_epoch_ms_timestamps",
    "memnos.migrations.versions.003_affects_edges_backfill",
]
...
async def _record_version(arcade, version: int, name: str) -> None:
    from memnos.time import now_ms
