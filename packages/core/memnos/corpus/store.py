"""
memnos.corpus.store — SQLite-backed registry of ingested corpus sources.

Each Corpus record tracks a directory or git repo that has been ingested into
memnos as structured constraint/decision/fact nodes.  The store is intentionally
...
_DEFAULT_DB_PATH = os.environ.get(
    "MEMNOS_CORPUS_DB",
    str(Path.home() / ".memnos" / "corpus.db"),
)
