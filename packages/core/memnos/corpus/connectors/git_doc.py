"""
memnos.corpus.connectors.git_doc — Connector for git repositories containing docs.
...
Usage::
    ...
    connector = GitDocConnector(
        corpus_id="gridops-platform",
        namespace="org:acme:gridops:architecture",
        source_path="/path/to/gridops-platform/docs",
        path_pattern="**/*.md",
    )
    result = await connector.sync(memnos_client)
...
from memnos.corpus.extractor import ExtractedNode, extract_corpus
