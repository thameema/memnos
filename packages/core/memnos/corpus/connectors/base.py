"""
memnos.corpus.connectors.base — Abstract base class for corpus source connectors.
...
3. Register the class in memnos.corpus.connectors.REGISTRY

Example::

    from memnos.corpus.connectors.base import ConnectorBase, ConnectorResult
    from memnos.corpus.extractor import ExtractedNode
...
class ConnectorBase(ABC):
    """Abstract base for all memnos corpus connectors.
    ...
    async def sync(self, client) -> ConnectorResult:
        """Extract nodes and write them to memnos via client.add().
        ...
        """
        from memnos.models import MemoryType, MemoryStatus, Provenance
