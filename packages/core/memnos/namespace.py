"""
memnos.namespace — Namespace access control manager.

Namespace definitions are loaded from ``MemnosConfig`` and evaluated at
...
if TYPE_CHECKING:
    from memnos.config import MemnosConfig, NamespaceDefinition
