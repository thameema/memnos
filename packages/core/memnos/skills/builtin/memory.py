"""Memory read/write skills — persistent storage via MemnosClient."""
import logging
...
@skill(
    ...
    parameters={
        ...
        "namespace": {
            "type": "string",
            "description": "Memnos namespace to search within (e.g. 'personal:default').",
...
async def memory_search(
    ...
    **kwargs,
    ...
    if client is None:
        return {"error": "memnos_client not provided", "results": []}
    try:
...
@skill(
    ...
    parameters={
        ...
        "namespace": {
            "type": "string",
            "description": "Memnos namespace to write into (e.g. 'personal:default').",
            "default": "personal:default",
        },
        "tags": {
            "type": "array",
...
async def memory_delete(
    ...
    **kwargs,
    ...
    client = kwargs.get("memnos_client")
    if client is None:
        return {"error": "memnos_client not provided", "deleted": False}
    try:
