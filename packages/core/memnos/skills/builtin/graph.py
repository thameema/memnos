...
@skill(
    ...
    parameters={
        ...
        "namespace": {
            "type": "string",
            "description": "Memnos namespace to query within (injected as $namespace).",
...
async def graph_query(
    ...
    **kwargs,
    ...
    client = kwargs.get("memnos_client")
    if client is None:
        return {"error": "memnos_client not provided", "rows": []}
    try:
...
@skill(
    ...
    parameters={
        ...
        "namespace": {
            "type": "string",
            "description": "Memnos namespace to search within.",
            "default": "personal:default",
        },
    },
    required=["name"],
...
async def get_entity(
    ...
    **kwargs,
    ...
    client = kwargs.get("memnos_client")
    if client is None:
        return {"error": "memnos_client not provided", "found": False}
    try:
...
@skill(
    ...
    parameters={
        ...
        "namespace": {
            "type": "string",
            "description": "Memnos namespace to traverse within.",
            "default": "personal:default",
        },
        "depth": {
            "type": "integer",
...
async def get_related(
    ...
    **kwargs,
    ...
    client = kwargs.get("memnos_client")
    if client is None:
        return {"error": "memnos_client not provided", "entities": [], "relations": []}
    try:
...
@skill(
    ...
    parameters={
        ...
        "namespace": {
            "type": "string",
            "description": "Memnos namespace to store the fact in.",
            "default": "personal:default",
        },
    },
...
async def add_fact(
    ...
    **kwargs,
    ...
    client = kwargs.get("memnos_client")
    if client is None:
        return {"error": "memnos_client not provided"}
    try:
