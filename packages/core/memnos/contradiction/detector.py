"""
memnos.contradiction.detector — Detects semantic contradictions before memory writes.
...
Override model with MEMNOS_CONTRADICTION_MODEL env var.
...
async def _llm_check_contradiction(new_content: str, existing_content: str) -> bool | None:
    ...
    try:
        if provider == "anthropic":
            ...
            model = os.environ.get("MEMNOS_CONTRADICTION_MODEL", "claude-haiku-4-5-20251001")
            ...
            model = os.environ.get("MEMNOS_CONTRADICTION_MODEL", "gpt-4o-mini")
