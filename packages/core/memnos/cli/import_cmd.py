"""
memnos-import — import a folder of markdown/text files into memnos.

Usage
-----
  memnos-import ~/vaults/myvault --namespace org:me:notes
  memnos-import ~/vaults/myvault --namespace org:myorg --discover
  memnos-import ~/vaults/myvault --namespace org:myorg --discover --dry-run
...
def _classify_with_claude(
    ...
    prompt = f"""You are classifying vault files into namespaces for an memnos memory system.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="memnos-import",
        description="Import a folder of markdown/text files into memnos with auto namespace discovery.",
...
Examples:
  ...
  memnos-import ~/vaults/myvault --namespace org:myorg --discover
  memnos-import ~/vaults/myvault --namespace org:myorg --discover --dry-run
  memnos-import ~/notes --namespace org:me --skip projects --skip .git
        """,
    )
    ...
    parser.add_argument("--server", default=os.environ.get("MEMNOS_SERVER", DEFAULT_SERVER),
                        help=f"memnos server URL (default: {DEFAULT_SERVER})")
    parser.add_argument("--api-key", default=os.environ.get("MEMNOS_API_KEY", ""),
                        help="memnos API key (default: MEMNOS_API_KEY env var)")
    ...
    if not args.api_key and not args.dry_run:
        ...
        print("        Set MEMNOS_API_KEY or pass --api-key if the server requires authentication.\n")
