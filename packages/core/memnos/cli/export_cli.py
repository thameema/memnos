"""memnos-export / memnos-import — namespace backup and restore."""
...
_API_URL = os.environ.get("MEMNOS_API_URL", "http://localhost:8766")
_API_KEY = os.environ.get("MEMNOS_API_KEY", "memnos-local-dev-key")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="memnos-export",
        description="Export and import memnos namespace memories.",
    )
