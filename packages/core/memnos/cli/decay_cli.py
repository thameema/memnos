"""
memnos.cli.decay_cli — memnos-decay CLI entry point.

Usage
-----
    memnos-decay --namespace org:my-team
    memnos-decay --namespace org:my-team --dry-run
    memnos-decay --namespace org:my-team --max-age-days 180 --max-idle-days 60
"""
...
async def _run(args: argparse.Namespace) -> int:
    ...
    from memnos.decay.job import run_decay_job, _DEFAULT_MAX_AGE_DAYS, _DEFAULT_MAX_IDLE_DAYS

    try:
        cfg = MemnosConfig.load()
    except Exception:
        cfg = None
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Namespace to scan (default: $MEMNOS_NAMESPACE or 'org:default')",
    )
    parser.add_argument(
