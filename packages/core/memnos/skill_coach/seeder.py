"""
memnos.skill_coach.seeder — Seeds tool skill memories into memnos.

Run via: memnos-skill-seed (CLI) or skill_discover MCP tool.
...
from memnos.skill_coach.capabilities import CLAUDE_CODE_CAPABILITIES, TOOL_CAPABILITY_CATALOGS
