"""
memnos_orchestrator.workers.openrouter_worker — OpenRouter API tool-calling agent.
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "namespace": {
                    "type": "string",
                    "description": "Memnos namespace to write into.",
                },
                "tags": {
                    "type": "array",
                    "items": {"type": "string"},
...
class OpenRouterWorker(BaseWorker):
    ...
    def __init__(
        ...
        site_url: str = "https://github.com/memnos",
        site_name: str = "memnos",
    ) -> None:
    ...
    async def _dispatch_tool(self, name: str, arguments_str: str) -> str:
        ...
        match name:
            ...
            case "memory_write":
                ...
                try:
                    memory = await self._memnos_client.add(
                        content=content,
                        namespace=namespace,
                        tags=tags,
                        source="agent",
