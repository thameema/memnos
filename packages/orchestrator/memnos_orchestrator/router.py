"""
memnos_orchestrator.router — Agent matching via semantic similarity over YAML agent definitions.
"""
...
class AgentRouter:
    ...
    def __init__(self, agents_dir: str, memnos_client: Any) -> None:
    ...
    async def init(self) -> None:
        ...
        try:
            embedder = getattr(self._memnos_client, "embedder", None)
