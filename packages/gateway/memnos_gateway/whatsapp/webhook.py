"""
memnos_gateway.whatsapp.webhook — FastAPI webhook receiver for Evolution API.
...
async def process_whatsapp_message(
    ...
    from memnos_gateway.whatsapp.evolution_client import EvolutionClient  # noqa: PLC0415
