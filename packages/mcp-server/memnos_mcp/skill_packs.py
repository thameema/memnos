"""
memnos_mcp.skill_packs — External MCP skill pack loader.
...
Directory discovery
-------------------
The loader scans ``MEMNOS_SKILL_PACKS_DIR`` (default: ``./skill_packs/``)
...
def load_skill_packs(
    ...
    *,
    ...
    ----------
    packs_dir:
        Directory to scan.  Defaults to ``MEMNOS_SKILL_PACKS_DIR`` env var,
    ...
    if packs_dir is None:
        packs_dir = os.environ.get("MEMNOS_SKILL_PACKS_DIR", _DEFAULT_PACKS_DIR)
