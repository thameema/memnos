...
from memnos_learning.models import EpisodicRecord, Outcome, SkillTemplate
...
class SkillExtractor:
    def __init__(self, api_key: str, model: str, skill_store: SkillStore, memnos_client=None):
