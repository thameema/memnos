"""
memnos_api.routers.subscriptions — Namespace pub-sub endpoints.
...
from memnos_api.auth import check_namespace_access, get_client, require_api_key, require_api_key_entry
...
async def stream_namespace(
    ...
    from memnos.subscription_bus import register as _register, unregister as _unregister
