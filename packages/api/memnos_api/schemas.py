"""
memnos_api.schemas — Pydantic v2 request/response models for the REST API.
"""
...
class MemoryWriteRequest(BaseModel):
    ...
    # Feature 5 — explicit per-write confidence. When None, server picks a
    # per-source default (see memnos.models.default_confidence_for_source).
...
class MemoryResponse(BaseModel):
    ...
    # Feature 5 — confidence in [0.0, 1.0]; defaults vary by source.
